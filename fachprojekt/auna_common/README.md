...
This directory contains centralized configuration files, maps, waypoints, worlds, and visualization configurations for the AuNa autonomous racing and navigation framework. By centralizing these resources, we avoid rebuilding ROS2 packages when only parameters or data files change.
...
- `config/model_params/race_car.yaml` - Race car robot model parameters
...
config_file = '/home/ubuntu/workspace/auna_common/config/control/params.yaml'
...
4. **Environment-Specific** - Easy switching between simulation configurations
5. **Docker Efficiency** - Mount separately from source code
